    ...
    var _Elimore = {
        ...
        ellipsis: function () {
            ...
            if (self.options.dataUrl) {
                ...
                var more_btn = '<a href="javascript:;" class="elimore_show">' + '<span>...</span>' + self.options.moreText + '</a>',
				...
				if(self.options.trimOnly){
					 ...
					 self.$el.append(text_one + '<span class="elimore_trim"' +
                         ' style="display:none">' + text_two + '</span>' + more_btn + less_btn);
				}
